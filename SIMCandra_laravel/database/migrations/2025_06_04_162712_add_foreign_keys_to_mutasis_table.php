...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('mutasis', function (Blueprint $table) {
            // Add foreign keys
            $table->foreignId('departemen_baru_id')->nullable()->constrained('departemens')->onDelete('set null');
            $table->foreignId('departemen_lama_id')->nullable()->constrained('departemens')->onDelete('set null');
    ...
    public function down(): void
    {
        Schema::table('mutasis', function (Blueprint $table) {
            ...
            $table->dropForeign(['departemen_lama_id']);
            $table->dropColumn('departemen_lama_id');
            $table->dropForeign(['departemen_baru_id']);
            $table->dropColumn('departemen_baru_id');
        });
    }
};
