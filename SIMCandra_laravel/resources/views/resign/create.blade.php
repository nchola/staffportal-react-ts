        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-dark shadow-primary border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3 mb-0">Form Pengajuan Resign</h6>
                </div>
            </div>
            <div class="card-body px-0 pb-2">
                <form method="POST" action="{{ route('resign.store') }}" class="p-3" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-outline my-3">
                                    <input type="date" name="tanggal_resign" class="form-control @error('tanggal_resign') is-invalid @enderror" value="{{ old('tanggal_resign') }}" required>
                                </div>
